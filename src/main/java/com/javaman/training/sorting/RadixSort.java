...
//		}
        ...
        log.info("����ǰ��ʱ����=" + date1Str);

        radixSort(arr);

        Date data2 = new Date();
        String date2Str = simpleDateFormat.format(data2);
        log.info("����ǰ��ʱ����=" + date2Str);
    ...
    public static void radixSort(int[] arr) {
        ...
        for (int i = 0, n = 1; i < maxLength; i++, n *= 10) {
            ...
            //log.info("��"+(i+1)+"�֣��Ը�λ�������� arr =" + Arrays.toString(arr));
		...
		log.info("��1�֣��Ը�λ�������� arr =" + Arrays.toString(arr));
		...
		log.info("��2�֣��Ը�λ�������� arr =" + Arrays.toString(arr));
		...
		log.info("��3�֣��Ը�λ�������� arr =" + Arrays.toString(arr)); */
